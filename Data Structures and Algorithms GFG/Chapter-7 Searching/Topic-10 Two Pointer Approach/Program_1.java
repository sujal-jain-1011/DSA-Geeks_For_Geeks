/*Java Program to Solve Two Sum Problem in a
        ...
        void two_sum_sorted(int target)
        {
            for(int i=0; i<size; i++)
            {
                for(int j=i+1; j<size; j++)
                {
                    ...
                    {
                        System.out.print("Sum of "+arr[i]+" and "+arr[j]+" equals "+target);
                        return;
                    }
                }
            }
            System.out.print("There are no two elements in the Array whose sum equals "+target);
        }
    }
