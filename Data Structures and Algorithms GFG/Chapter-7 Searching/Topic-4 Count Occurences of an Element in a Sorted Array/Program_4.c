...
/*Function to Find the Index of First Occurence of an Element-Using Iterative Binary Search*/
...
/*Function to Find the Index of Last Occurence of an Element-Using Iterative Binary Search*/
...
/*Function to Count Occurences of an Element*/
void count_occurence(int element)
{
    long long signed int count=0;
    if(ifo==-1)
    {
        printf("The Count of Occurences of %d is:%lld", element, count);
        return;
    }
    count=ilo-ifo+1;
    printf("The Count of Occurences of %d is:%lld", element, count);
...
int main()
{
    ...
    else
    {
        ...
        scanf("%d", &element);
        index_first_occurence(element);
        index_last_occurence(element);
        count_occurence(element);
    }
    return 0;
}
