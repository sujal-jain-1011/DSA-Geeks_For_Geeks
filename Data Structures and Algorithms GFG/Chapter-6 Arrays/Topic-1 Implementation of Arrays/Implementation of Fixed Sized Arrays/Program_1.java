/*Java Program to Implement Fixed Sized Array 
using Heap Allocation(Memory from Heap)*/
...
class Program_1{
    ...
    class Implement_Fixed_Sized_Array{
        ...
        boolean create_a_fixed_sized_array()
        {
            Scanner sc=new Scanner(System.in);
            readInput(sc);
            /*User is advised to enter a Non-Negative Integer that is
            greater than or equal to 0 and less than (2 raised to power 31)
