/*Java Program to Find Maximum Sum of a Given Size 
...
class Program_1{
    ...
    public static void main(String[] args)
    {
        ...
        else
        {
            ...
            sub_size=sc.nextInt();
            System.out.println("The Maximum Sum that a Subarray of Size "+sub_size+" can produce is:"+IFSA.max_sum(sub_size));
        }
        sc.close();
    }
}