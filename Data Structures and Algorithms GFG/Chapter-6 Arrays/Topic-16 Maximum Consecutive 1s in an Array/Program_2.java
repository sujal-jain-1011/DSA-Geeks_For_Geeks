/*Java Program to Find Maximum Consecutive 1's
...
class Program_2{
    ...
    class Implement_Fixed_Sized_Array{
        ...
        /*Member Function of class:
        to Convert an integer Array to Bool Array*/
        ...
        /*Member Function of class:
        to Find Maximum Consecutive 1's*/
        int maximum_consecutive_1()
        {
    ...
    public static void main(String[] args)
    {
        ...
        {
            IFSA.display();
            IFSA.convert_to_bool();
            System.out.println("After converting the int Array to bool Array we have Array as:");
            IFSA.display();
            System.out.println("The Count of Maximum Consecutive 1's in the Array is:"+IFSA.maximum_consecutive_1());
        }
        sc.close();
    }
}
